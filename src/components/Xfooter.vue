<template>
  <div class="bottom-nav-bar">
    <router-link to="../app/movie" class="nav-icon-wrapper current" data-tab=".movie"  >
    ...
    <router-link to="../app/cinema" class="nav-icon-wrapper" data-tab=".cinema" @click="goto('Cinema')">
    ...
    <router-link to="../app/mine" class="nav-icon-wrapper" data-tab=".my" @click="goto('Mine')">
